...
export const DRAFTED_PLAYERS = [
  { name: "Druw Jones", team: "Arizona Diamondbacks", round: "1st Round", position: "OF" },
  { name: "Termarr Johnson", team: "Pittsburgh Pirates", round: "1st Round", position: "INF" },
  { name: "Justin Crawford", team: "Philadelphia Phillies", round: "1st Round", position: "OF" },
  { name: "Mikey Romero", team: "Boston Red Sox", round: "1st Round", position: "SS" },
  { name: "Malcolm Moore", team: "Texas Rangers", round: "1st Round", position: "C" },
  { name: "Ralphy Velazquez", team: "Cleveland Guardians", round: "1st Round", position: "C" },
  { name: "Cam Caminiti", team: "Atlanta Braves", round: "1st Round", position: "INF" },
  { name: "Seth Hernandez", team: "Pittsburgh Pirates", round: "1st Round", position: "P" },
  { name: "Billy Carlson", team: "Chicago White Sox", round: "1st Round", position: "INF" },
  { name: "Gavin Fien", team: "Texas Rangers", round: "1st Round", position: "P" },
  { name: "Kayson Cunningham", team: "Arizona Diamondbacks", round: "1st Round", position: "SS" },
  { name: "Tate Southisene", team: "Atlanta Braves", round: "1st Round", position: "OF" },
  { name: "Kruz Schoolcraft", team: "San Diego Padres", round: "1st Round", position: "P" },
  { name: "Brady Ebel", team: "Milwaukee Brewers", round: "1st Round", position: "P" },
  { name: "Levi Sterling", team: "Pittsburgh Pirates", round: "2nd Round", position: "P" },
  { name: "Boston Bateman", team: "San Diego Padres", round: "2nd Round", position: "OF" },
  { name: "Angel Cervantes", team: "Pittsburgh Pirates", round: "2nd Round", position: "INF" },
  { name: "Quentin Young", team: "Pittsburgh Pirates", round: "2nd Round", position: "OF" },
  { name: "Chris Paciolla", team: "Chicago Cubs", round: "3rd Round", position: "C" },
  { name: "Eric Bitonti", team: "Milwaukee Brewers", round: "3rd Round", position: "P" },
  { name: "Brandon Winokur", team: "Minnesota Twins", round: "3rd Round", position: "INF" },
  { name: "Antonio Anderson", team: "Boston Red Sox", round: "3rd Round", position: "OF" },
  { name: "Dean Moss", team: "Tampa Bay Rays", round: "3rd Round", position: "P" },
  { name: "Jacob Reimer", team: "New York Mets", round: "4th Round", position: "P" },
  { name: "RJ Austin", team: "Baltimore Orioles", round: "4th Round", position: "INF" },
  { name: "Landon Hodge", team: "Chicago White Sox", round: "4th Round", position: "OF" },
  { name: "Mason Neville", team: "Cincinnati Reds", round: "4th Round", position: "P" },
  { name: "Kaleb Wing", team: "Chicago Cubs", round: "4th Round", position: "OF" },
  { name: "Nick Montgomery", team: "Atlanta Braves", round: "5th Round", position: "INF" },
  { name: "Josiah Hartshorn", team: "Chicago Cubs", round: "6th Round", position: "P" },
  { name: "Dylan Fien", team: "Oakland Athletics", round: "7th Round", position: "P" },
  { name: "Boston Baro", team: "New York Mets", round: "8th Round", position: "OF" },
  { name: "Trevor Heishman", team: "Detroit Tigers", round: "9th Round", position: "P" },
  { name: "CJ Hughes", team: "Milwaukee Brewers", round: "11th Round", position: "INF" },
  { name: "Nick Peoples", team: "Washington Nationals", round: "12th Round", position: "OF" },
  { name: "Omari Daniels", team: "Minnesota Twins", round: "14th Round", position: "OF" },
  { name: "Jaden Noot", team: "Milwaukee Brewers", round: "19th Round", position: "P" },
  { name: "Sam Parker", team: "Minnesota Twins", round: "19th Round", position: "P" },
  { name: "Austin Charles", team: "Kansas City Royals", round: "20th Round", position: "OF" },
  { name: "Easton Shelton", team: "Los Angeles Dodgers", round: "Signed", position: "INF" },
  { name: "Luke Scherrer", team: "Pittsburgh Pirates", round: "Signed", position: "P" },
  { name: "Jaden Fielder", team: "Milwaukee Brewers", round: "Signed", position: "OF" },
  { name: "Rashawn Pinder", team: "Texas Rangers", round: "Int'l Signing", position: "OF" },
  { name: "Bohan Adderly", team: "New York Mets", round: "Int'l Signing", position: "INF" },
] as const;

export const MLB_TEAMS: Record<string, { color: string; abbr: string }> = {
  "Arizona Diamondbacks": { color: "#A71930", abbr: "ARI" },
  "Atlanta Braves": { color: "#CE1141", abbr: "ATL" },
  "Baltimore Orioles": { color: "#DF4601", abbr: "BAL" },
  "Boston Red Sox": { color: "#BD3039", abbr: "BOS" },
  "Chicago Cubs": { color: "#0E3386", abbr: "CHC" },
  "Chicago White Sox": { color: "#27251F", abbr: "CWS" },
  "Cincinnati Reds": { color: "#C6011F", abbr: "CIN" },
  "Cleveland Guardians": { color: "#00385D", abbr: "CLE" },
  "Detroit Tigers": { color: "#0C2340", abbr: "DET" },
  "Kansas City Royals": { color: "#004687", abbr: "KC" },
  "Los Angeles Dodgers": { color: "#005A9C", abbr: "LAD" },
  "Milwaukee Brewers": { color: "#FFC52F", abbr: "MIL" },
  "Minnesota Twins": { color: "#002B5C", abbr: "MIN" },
  "New York Mets": { color: "#002D72", abbr: "NYM" },
  "Oakland Athletics": { color: "#003831", abbr: "OAK" },
  "Philadelphia Phillies": { color: "#E81828", abbr: "PHI" },
  "Pittsburgh Pirates": { color: "#FDB827", abbr: "PIT" },
  "San Diego Padres": { color: "#2F241D", abbr: "SD" },
  "Seattle Mariners": { color: "#0C2C56", abbr: "SEA" },
  "Tampa Bay Rays": { color: "#092C5C", abbr: "TB" },
  "Texas Rangers": { color: "#003278", abbr: "TEX" },
  "Washington Nationals": { color: "#AB0003", abbr: "WSH" },
};
