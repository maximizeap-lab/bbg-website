...
export async function sendDonationReceipt(params: {
  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family: 'DM Sans', Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #000000; color: #FFFFFF; padding: 40px;">
        <div style="text-align: center; margin-bottom: 32px;">
          <h1 style="font-family: 'Bebas Neue', Arial, sans-serif; font-size: 36px; color: #F5A623; margin: 0;">BASEBALL GENERATIONS</h1>
          <p style="color: #FFFFFF; opacity: 0.7; margin-top: 4px;">From South LA to the Big Leagues</p>
        </div>
        <div style="background: #1a1a1a; border-radius: 12px; padding: 32px; margin-bottom: 24px;">
        ...
        <div style="background: #1a1a1a; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
          <h3 style="color: #FFFFFF; margin-top: 0;">Tax Receipt</h3>
