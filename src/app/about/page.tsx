            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-2xl bg-white/5 border border-white/10">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="mx-auto h-20 w-20 rounded-full bg-gold/10 flex items-center justify-center">
                  ...
                  <p className="mt-4 font-accent text-sm uppercase tracking-wider text-white/40">
                    BBG Origins — South LA
                  </p>
                </div>
              </div>
              {/* Gold corner accents */}
